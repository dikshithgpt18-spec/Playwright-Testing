 ...
 */
test('Parallel tabs hitting the SAME Warranty page API simultaneously at once', async ({ browser }, testInfo) => {
    ...
    for (let cycle = 1; cycle <= repeatCount; cycle++) {
        ...
        for (let i = 0; i < warrantySubSections.length; i++) {
            ...
            // Phase A: Ensure Warranty menu header is expanded on ALL tabs concurrently
